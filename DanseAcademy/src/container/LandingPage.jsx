    ...
    <section className={styles.landing} ref={landingRef} id="home">
      <div
        className="absolute inset-0 flex flex-col items-center justify-center
                      gap-10 bg-black bg-opacity-50 text-center text-slate-100">
        <h3 className="z-10 max-w-[80vw] cursor-default font-Permanent-Marker text-5xl font-bold lg:text-7xl">
          ¡Vení y parchate a bailar!
        </h3>
        <p className="z-10 max-w-[80vw] cursor-default text-xl md:max-w-[70vw] lg:text-3xl">
