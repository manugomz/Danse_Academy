  ...
  return (
    <footer className="bg-gray-dark py-3">
      ...
      cursor-default items-center">
        <div>
          <h1><img src="../images/Round_Logo.png" className=" h-32 md:h-20 mx-auto" alt="Dansé Academy Studio"/></h1>
          <p className="md:text-[0.8em] my-2 md:text-yellow-light">Estudio de danza</p>
        </div>
        <div className="flex flex-wrap justify-center gap-1 md:inline md:text-left">
    ...
    <div className="flex pb-5 pt-2 md:pt-0 justify-center gap-3">
      <Link className=" hover:bg-slate-500 p-1 rounded-md" to="https://bit.ly/DanseAcademyStudio" target='_blank'><FaWhatsapp className="text-yellow-dark text-[1.5rem] hover:text-white"/></Link>
