...
const Header = () => {
  ...
  const styles = {
    bar:`flex w-auto md:h-full items-center md:justify-between 
    ...
    <header
      ...
      <div className={styles.bar}>
        ...
        <nav className={styles.navDesktop}>
          ...
          <button key="home" className={styles.headerButton} onClick={()=>scrollToElement(landingRef)}>{/*HOME */}
          ...
          <button key="events" className={styles.headerButton} onClick={()=>scrollToElement(eventsRef)} > {/*EVENTOS */}
            <div className="pl-2">
          ...
          <button key="classes" className={styles.headerButton} onClick={()=>scrollToElement(classesRef)} >{/*CLASES */}
            <div className="pl-2">
          ...
          <button key="schedule" className={styles.headerButton} onClick={()=>scrollToElement(scheduleRef)} href="#horarios">{/*HORARIOS */}
